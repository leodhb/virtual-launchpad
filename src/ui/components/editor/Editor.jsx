...
function Editor() {
  ...
  const updateFile = (file) => {
    ...
    setSendButtonText(
      <span>
        <i className="fa fa-check"></i> Enviado<br></br>
        {file.name}
      </span>
    );
  };
  ...
  return (
    <div
      className={`editor-container col-lg-3 ${
        editorVisible ? "" : "editor-closed"
      }`}
    >
      <div className=" p-4 editor-window">
        ...
        <div className="d-grid gap-2">
          <button
            className="btn btn-light text-light file-upload "
        ...
        <div className="d-grid gap-2">
          <input
            className="form-control mb-4 pad-color-picker"
            type="color"
            id="color"
            name="color"
            value={padObject.color}
